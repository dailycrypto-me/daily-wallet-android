...
{ // implements EthereumNetworkRepositoryType
    public static final long DAILY_ID = 824;
    public static final long DAILY_TEST_ID = 825;
    ...
    {
        {
            put(DAILY_ID, new NetworkInfo("Daily Network", "DLY", DAILY_RPC_URL, "https://explorer.mainnet.dailycrypto.net/tx/",
                    DAILY_ID, false));
            put(DAILY_TEST_ID, new NetworkInfo("Daily Network", "DLY", DAILY_TEST_RPC_URL, "https://explorer.testnet.dailycrypto.net/tx/",
                    DAILY_TEST_ID, false));
