...
import static com.alphawallet.ethereum.EthereumNetworkBase.DAILY_ID;
import static com.alphawallet.ethereum.EthereumNetworkBase.DAILY_RPC_URL;
import static com.alphawallet.ethereum.EthereumNetworkBase.DAILY_TEST_ID;
import static com.alphawallet.ethereum.EthereumNetworkBase.DAILY_TEST_RPC_URL;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    /* constructing URLs from BuildConfig. In the below area you will see hardcoded key like da3717...
       These hardcoded keys are fallbacks used by DailyWallet forks.
    ...
    //Note that DailyWallet now uses a double node configuration. See class AWHttpService comment 'try primary node'.
    ...
    public static final String DAILY_RPC_URL = "https://rpc.mainnet.dailycrypto.net";
    public static final String DAILY_TEST_RPC_URL = "https://rpc.testnet.dailycrypto.net";
    ...
    private static final List<Long> hasValue = new ArrayList<>(Arrays.asList(
            DAILY_ID, MAINNET_ID, /*GNOSIS_ID, POLYGON_ID, ROOTSTOCK_MAINNET_ID, CLASSIC_ID, LINEA_ID, BASE_MAINNET_ID, MANTLE_MAINNET_ID, MINT_ID, */BINANCE_MAIN_ID/*, HECO_ID, AVALANCHE_ID,
    ...
    private static final List<Long> testnetList = new ArrayList<>(Arrays.asList(
            DAILY_TEST_ID/*, SEPOLIA_TESTNET_ID, POLYGON_AMOY_ID, HOLESKY_ID, BASE_TESTNET_ID, MINT_SEPOLIA_TESTNET_ID, GOERLI_ID, BINANCE_TEST_ID,
    ...
    {
        {
            put(DAILY_ID, new NetworkInfo(C.DAILY_NETWORK_NAME, C.DLY_SYMBOL,
                    DAILY_RPC_URL,
                    "https://explorer.mainnet.dailycrypto.net/tx/", DAILY_ID, DAILY_RPC_URL,
                    "https://rpc.mainnet.dailycrypto.net?"));
            put(DAILY_TEST_ID, new NetworkInfo(C.DAILY_TEST_NETWORK_NAME, C.DLY_TEST_SYMBOL,
                    DAILY_TEST_RPC_URL,
                    "https://explorer.testnet.dailycrypto.net/tx/", DAILY_TEST_ID, DAILY_TEST_RPC_URL,
    ...
    {
        {
            put(DAILY_ID, R.drawable.ic_dly_logo);
            put(DAILY_TEST_ID, R.drawable.ic_dly_test_logo);
    ...
    {
        {
            put(DAILY_ID, R.color.mainnet);
            put(DAILY_TEST_ID, R.color.mainnet);
