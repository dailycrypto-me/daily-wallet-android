...
public abstract class C {
    ...
    public static final String DAILY_NETWORK_NAME = "Daily Network";
    public static final String DAILY_TEST_NETWORK_NAME = "Daily Test Network";
    ...
    public static final String DLY_SYMBOL = "DLY";
    public static final String DLY_TEST_SYMBOL = "DLY";
    ...
    public static final String DAILYWALLET_WEB = "https://dailycrypto.net";
    ...
    public static final String DEFAULT_NETWORK = DAILY_NETWORK_NAME;
    ...
    public static final String DAPP_PREFIX_DAILYWALLET = "dailywallet";
    ...
    public static final String DAILYWALLET_LOGO_URI = "https://i.ibb.co/Y7dPsmsx/daily-logo.png";
    public static final String DAILYWALLET_WEBSITE = "https://dailycrypto.net";
    public static final String WALLET_CONNECT_REACT_APP_RELAY_URL = "wss://relay.walletconnect.com";
    public static final String DAILY_WALLET_LOGO_URL = "https://i.ibb.co/Y7dPsmsx/daily-logo.png";
    ...
    public static final String EXTERNAL_APP_DOWNLOAD_LINK = "https://dailycrypto.net/download/DailyWallet-release-build.apk";
