...
public class NotificationSettingsViewModel extends BaseViewModel
{
    ...
    {
        disposable = dailyWalletNotificationService.subscribe(chainId)
    ...
    {
        disposable = dailyWalletNotificationService.unsubscribe(chainId)
            .observeOn(Schedulers.io())
            .subscribeOn(Schedulers.io())
    ...
    {
        dailyWalletNotificationService.unsubscribeToTopic(chainId);
    }
