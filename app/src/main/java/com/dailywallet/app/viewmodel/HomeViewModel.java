...
import com.alphawallet.app.service.DailyWalletNotificationService;
...
{
    public static final String DAILYWALLET_DIR = "DailyWallet";
    ...
    private final DailyWalletNotificationService dailyWalletNotificationService;
    ...
    HomeViewModel(
            ...
            DailyWalletNotificationService dailyWalletNotificationService,
            GasService gasService)
    {
        ...
        this.dailyWalletNotificationService = dailyWalletNotificationService;
    ...
    private Request getRequest()
    {
        return new Request.Builder()
            ...
            .url("https://api.github.com/repos/dailycrypto-me/daily-wallet-android/releases")
            .get()
            .build();
    }
    ...
    {
        dailyWalletNotificationService.subscribe(com.alphawallet.ethereum.EthereumNetworkBase.MAINNET_ID);
    }

    public void unsubscribeToNotifications()
    {
        dailyWalletNotificationService.unsubscribeToTopic(com.alphawallet.ethereum.EthereumNetworkBase.MAINNET_ID);
    }
