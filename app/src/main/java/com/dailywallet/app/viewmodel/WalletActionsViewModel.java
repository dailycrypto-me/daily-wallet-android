...
//            dailyWalletNotificationService.unsubscribe(EthereumNetworkBase.MAINNET_ID)
//                .observeOn(Schedulers.io())
//                .subscribeOn(Schedulers.io())
//                .subscribe(result -> Timber.d("unsubscribe result => " + result), Timber::e);

        // For now, unsubscribe to firebase topic
        dailyWalletNotificationService.unsubscribeToTopic(EthereumNetworkBase.MAINNET_ID);
    }
