...
import static com.alphawallet.app.util.Utils.DAILYWALLET_REPO_NAME;
...
public class TokenIcon extends ConstraintLayout
{
    ...
    private void displayTokenIcon(String iconUrl)
    {
        ...
        final RequestOptions optionalCircleCrop = squareToken || iconUrl.startsWith(DAILYWALLET_REPO_NAME) ? new RequestOptions() : new RequestOptions().circleCrop();
    ...
    private void loadFromAltRepo(Object model)
    {
        ...
        if (checkUrl.startsWith(DAILYWALLET_REPO_NAME))
        {
            useContractURI = true;
        }
