...
public class Web3View extends WebView {
    ...
    private static final String JS_PROTOCOL_ON_SUCCESSFUL = "DailyWallet.executeCallback(%1$s, null, \"%2$s\")";
    private static final String JS_PROTOCOL_EXPR_ON_SUCCESSFUL = "DailyWallet.executeCallback(%1$s, null, %2$s)";
    private static final String JS_PROTOCOL_ON_FAILURE = "DailyWallet.executeCallback(%1$s, \"%2$s\", null)";
    ...
    public void init()
    {
        ...
        getSettings().setUserAgentString(getSettings().getUserAgentString()
                + "DailyWallet(Platform=Android&AppVersion=" + BuildConfig.VERSION_NAME + ")");
