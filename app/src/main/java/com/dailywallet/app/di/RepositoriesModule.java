...
import com.alphawallet.app.service.DailyWalletService;
...
public class RepositoriesModule
{
    ...
    @Singleton
    @Provides
    DailyWalletService provideFeemasterService(OkHttpClient okHttpClient, Gson gson)
    {
        return new DailyWalletService(okHttpClient, gson);
    }
    ...
    @Singleton
    @Provides
    DailyWalletNotificationService provideDailyWalletNotificationService(WalletRepositoryType walletRepository)
    {
        return new DailyWalletNotificationService(walletRepository);
    }
}
