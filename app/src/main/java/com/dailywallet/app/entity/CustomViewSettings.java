...
{
    public static final long primaryChain = DAILY_ID;
    private static final String primaryChainName = C.DAILY_NETWORK_NAME;
    ...
    private static final List<Long> lockedChains = Arrays.asList(
        //EthereumNetworkBase.DAILY_ID,
        //EthereumNetworkBase.DAILY_TEST_ID
