...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.stormbird.dailywallet\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("http://dailycrypto.net");
    }
            ...
            throws IOException, SAXException, NoHandlerFoundException
    {
        ...
        {
            return "If you are using DailyWallet with WalletConnect and facing issues please take the following steps:<br/><br/>\nTry using WalletConnect V2 (or latest version)<br/>\nTry launching the application from within DailyWallet app's Browser tab.<br/>";
        }
